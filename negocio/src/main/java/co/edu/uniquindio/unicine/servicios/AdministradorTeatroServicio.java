...
public interface AdministradorTeatroServicio {
    ...
    //Servicios CRUD de administrador de teatro
    ...
    List<AdministradorTeatro> listarAdmiTeatros();
    ...
    List<Sala> obtenerListaSalasTeatro (Integer codigoTeatro);
    ...
    List<Funcion> obtenerListaFuncionesHorario (Integer codigoHorario) ;
    ...
    List<Compra> obtenerListaComprasFuncion (Integer codigoFuncion);
    ...
    List<Sala> obtenerSalasDistribucionSilla(Integer codigoDistribucionSilla) ;
